...
public class ModelGhastlyBoat extends ModelBase{
    ...
    public ModelGhastlyBoat()
    {
        ...
        this.boatSides[0].setRotationPoint(0.0F, 21.0F, 1.0F);
        this.boatSides[1].addBox(-13.0F, -7.0F, -1.0F, 18, 6, 2, 0.0F);
        this.boatSides[1].setRotationPoint(-15.0F, 22.0F, 4.0F);
        this.boatSides[2].addBox(-8.0F, -7.0F, -1.0F, 16, 6, 2, 0.0F);
        this.boatSides[2].setRotationPoint(15.0F, 22.0F, 0.0F);
        this.boatSides[3].addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        this.boatSides[3].setRotationPoint(0.0F, 22.0F, -9.0F);
        this.boatSides[4].addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        this.boatSides[4].setRotationPoint(0.0F, 22.0F, 9.0F);
        ...
        this.noWater.setRotationPoint(0.0F, 15.0F, 1.0F);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityGhastlyBoat entityboat = (EntityGhastlyBoat)entityIn;
    ...
    protected void renderPaddle(EntityGhastlyBoat boat, int paddle, float scale, float limbSwing)
    {
